...
!function ($) {
    ...
    Dashboard.prototype.init = function () {
        ...
        this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b', 'c'], ['Series A', 'Series B', 'Series C'], ['#508aeb', '#fcc24c', '#FFC61A']);
        ...
        this.createDonutChart('morris-donut-example', $donutData, ['#54cc96', "#FFC61A", '#508aeb', '#fcc24c']);
