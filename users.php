<?php require_once("action/act.view_users.php"); ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8" />
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <h5 class="page-title">View Users <a href="add_user" style="margin-left:50px" class="btn btn-success waves-effect waves-light">Add User</a></h5>
                                </div>
                            </div>
                            <!-- end row -->
                                                    ...
                                                    <table id="datatable" class="table table-bordered dt-responsive nowrap table-striped focus-on" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th data-priority="1">USER TYPE</th>
                                                                <th>ACTION</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
