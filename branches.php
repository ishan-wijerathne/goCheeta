<?php require_once("action/act.branches.php"); ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8" />
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <h5 class="page-title">Branches <a href="javascript:;" style="margin-left:50px" class="btn btn-success waves-effect waves-light mad" id="dr">Add Branch</a></h5>
                                </div>
                            </div>
                            <!-- end row -->
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <form action="branches" method="post">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                    ...
                                                                                    <input required placeholder="Branch Name" class="form-control" name="branch" id="branch">
                                                                            </div>
