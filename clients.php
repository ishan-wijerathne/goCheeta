<?php require_once("action/act.view_clients.php"); ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8" />
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <h5 class="page-title">View Clients  <a href="add_client" style="margin-left:50px" class="btn btn-success waves-effect waves-light">Add Client</a></h5>
                                </div>
                            </div>
                            <!-- end row -->
