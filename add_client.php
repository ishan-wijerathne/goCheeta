<?php require_once("action/act.add_client.php"); ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8" />
                                ...
                                <div class="col-sm-12">
                                    <div class="float-right page-breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active"><?=$title?> Client</li>
                                        </ol>
                                    </div>
                                    <h5 class="page-title"><?=$title?> Client</h5>
                                </div>
                            </div>
                            <!-- end row -->
                            <div class="row">
...
<!--                                            <h4 class="mt-0 header-title">User Details</h4>-->
                                              ...
                                              ?>
                                            <form action="<?php if(!isset($_GET['id'])){echo'add_client.php';}?>" method="post">
